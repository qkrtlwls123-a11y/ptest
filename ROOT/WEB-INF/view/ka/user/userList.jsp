...
<head>
	...
	var User = {
			...
			userInfoPop : function(action_mode,id){ //수정 화면
				var url = "/ka/user/goUserInfoPop.do";
				var title = "등록";
			...
			userAction : function(action_mode){ //추가/수정/삭제 액션
				...
				if(action_mode == "modify" || action_mode == "regist"){
					...
					isAllow = confirm("사용자 정보를 삭제하시겠습니까?");
				}
			 ...
			 downloadExcel:function (){
				if(confirm("엑셀로 다운로드 하시겠습니까?")){
					...
					form.action = "/ka/user/adminUserListExcel.do";
					form.submit();
				}
			},
	...
	<div id="container" class="printNone">	
		...
		<div id="content" class="admin_con">
			...
			<form id="UserListForm" action="">
				...
				<input type="hidden" id="s_user_type" name="s_user_type" value="A"/>
			...
			<div class="btn_space_listT">
				...
				<input type="button" value="엑셀업로드" onclick="User.fileUploadForm('raw_regist')"/>
				 -->
