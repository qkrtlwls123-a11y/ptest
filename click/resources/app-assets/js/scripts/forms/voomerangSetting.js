...
$(document).ready(function(){
	$("#voomerangSetting").addClass("active");
});

function fn_updateVoomerangSetting(){
	var params = $("form[name=parameterVO]").serialize();
	$.ajax({
		url : "/voomerang/updateVoomerangSetting.json",
		type : "POST",
		data : params,
		success : function(result) {
			if (result.resultCode == "success") {
				location.href = "/voomerang/voomerangSetting.do";
			} else {
				location.href = "/voomerang/voomerangSetting.do";
			}
		}
