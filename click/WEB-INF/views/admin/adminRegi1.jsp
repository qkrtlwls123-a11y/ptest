								...
								<td colspan="3">
									<span>
										<c:if test="${sessionVO.grade_id == '1'}">
											<spring:message code="click.system.administrator"/>
										</c:if>
										<c:if test="${sessionVO.grade_id == '2'}">
											<spring:message code="click.head.office.manager"/>
										</c:if>
										<c:if test="${sessionVO.grade_id == '3'}">
											<spring:message code="click.site.manager"/>
										</c:if>
										<c:if test="${sessionVO.grade_id == '4'}">
											<spring:message code="click.supplier.manager"/>
										</c:if>
										<c:if test="${sessionVO.grade_id == '5'}">
											<spring:message code="click.user"/>
										</c:if>
									</span>
								</td>
							</tr>
					...
					<div class="table mt10 mb20 font14 no-hover">
						...
						<tbody>
							<tr>
								...
								<td>
									<span>
										<c:if test="${sessionVO.account_employee_number != '' && sessionVO.account_employee_number != null}">${sessionVO.account_employee_number}</c:if>
										<c:if test="${sessionVO.account_employee_number == '' || sessionVO.account_employee_number == null}">-</c:if>
									</span>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<span>
										<c:if test="${sessionVO.account_id != '' && sessionVO.account_id != null}">${sessionVO.account_id}</c:if>
										<c:if test="${sessionVO.account_id == '' || sessionVO.account_id == null}">-</c:if>
									</span>
								</td>
							</tr>
							<tr>
