...
<head>
	...
	function fn_insertSite() {
		var logoId = '${logoId}';
		var backId = '${backId}';
		
		if("" != logoId && undefined != logoId){
			$("#site_logo").val(logoId);
		}
		
		if("" != backId && undefined != backId){
			$("#site_back").val(backId);
		}
		
		var params = $("form[name=parameterVO]").serialize();
		$.ajax({
			url : "${pageContext.request.contextPath}/insertSite.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    	...
                                    	<input type="hidden" id="site_back" name="site_back" value=""/>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="고객사명 " name="company_name" value="" required data-validation-required-message="고객사 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>홈페이지</label>
                                                    <input type="text" class="form-control" name="homepage_url" placeholder="홈페이지">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="business_no" placeholder="사업자등록번호" value="" required data-validation-required-message="사업자등록번호는 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                            </div>
                                        	...
                                        	<div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="사이트 명 " name="site_name" value="" required data-validation-required-message="사이트 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls position-relative">
                                                        ...
                                                        <div class="col-xl-9 col-md-12 d-flex align-items-lg-start align-items-sm-start align-items-xs-start  align-items-center flex-wrap px-0 pt-xl-0 pt-1">
			                                                <div class="issue-date d-flex align-items-center justify-content-start mr-2 mb-75 mb-xl-0 w-48">
			                                                    <input type="text" name="start_date" class="pick-a-date bg-white form-control" value="" required>
			                                                </div>
			                                                <div class="due-date d-flex align-items-center justify-content-start w-48">
			                                                    <input type="text" name="end_date" class="pick-a-date bg-white form-control" value="" required>
			                                                </div>
			                                            </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control w-25" name="user_count" placeholder="회원 수">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="media mb-1">
                                        	...
                                        	<div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="manager_name" placeholder="성명 " value="" required data-validation-required-message="성명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls position-relative">
                                                        <label><span class="required-star">*</span> 이메일</label>
                                                        <input type="text" class="form-control" name="manager_email" placeholder="이메일 " value="" required data-validation-required-message="이메일은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label><span class="required-star">*</span> 전화번호</label>
                                                    <input type="text" class="form-control" name="manager_phone" placeholder="전화번호">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
					                        <div class="col-12 col-sm-6">
					                            <div class="card">
			                                    	...
			                                    	<p><input type="file" id="logoZone" class="form-control-file fileuploadFile" style="display:none;width:100%;"/><label for="logoZone" class="btn btn-primary">로고 업로드</label><label id="logoFileName" style="padding-left:20px;"></label></p>
			                                    	<p id="logoImage"></p>
					                            </div>
					                        </div>
					                        <div class="col-12 col-sm-6">
					                            <div class="card">
			                                        ...
			                                        <p><input type="file" id="backZone" class="form-control-file fileuploadFile" style="display:none;width:100%;"/><label for="backZone" class="btn btn-primary">배경 업로드</label><label id="backFileName" style="padding-left:20px;"></label></p>
			                                    	<p id="backImage"></p>
					                            </div>
					                        </div>
					                    </div>
                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            <button type="button" onclick="javascript:fn_insertSite();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">등록</button>
