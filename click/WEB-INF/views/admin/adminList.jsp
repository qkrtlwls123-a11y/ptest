...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
	...
	function fn_siteRegi(){
		location.href="${pageContext.request.contextPath}/adminRegi.do";
	}
	
	function fn_updateSite(idx){
		$("#admin_email").val(idx);
		document.parameterVO.action = "${pageContext.request.contextPath}/adminUpdate.do";
                                                ...
                                                <tbody>
                                                	<c:forEach var="resultList" items="${resultList}">
	                                                    ...
	                                                    <tr>
	                                                        ...
	                                                        <td class="text-center">
	                                                        	<button type="button" class="btn btn-danger btn-sm" onclick="javascript:fn_sendMail('${resultList.admin_email}');return false;">인증 메일 발송</button>
	                                                        </td>
