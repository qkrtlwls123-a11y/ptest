  ...
  <script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function fn_gameSetting(){
			...
			setTimeout(fn_settingGameClick, 500);
		...
		$(document).on("click", ".insertGame", function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/updateGame.json",
				type : "POST",
				data : params,
			...
			<div class="card shadow-none p-0 m-0">
				...
				<div class="rightArea card-content" id="gameSettingArea">
					<form name="parameterVO" id="parameterVO">
						...
						<input type="hidden" name="game_id" value="${parameterVO.game_id}"/>
						...
						<div class="card-body py-0 border-bottom">
							...
							<p><div class="inputBox"><input type="text" required="required" id="game_name" name="game_name" class="required" value="${gameVO.game_name}"/><span class="place-span">게임 명</span></div>
						</div>
						<div class="card-body py-0 border-bottom">
							<div class="assigned d-flex justify-content-between">
								<div class="form-group d-flex align-items-center position-relative font-medium-1 fw-500 ept-20">
							...
							<p><div class="inputBox"><input type="text" required="required" id="game_count" name="game_count" class="w-50 required" value="${gameVO.game_count}"/><span class="place-span">개수</span></div>
						</div>
						<div class="card-body py-0 border-bottom">
							<div class="assigned d-flex justify-content-between">
								<div class="form-group d-flex align-items-center position-relative font-medium-1 fw-500 ept-20">
							...
							<div id="rouletteColorArea" style="display:inline-block;">
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue1" name="game_text_1" class="required" value="${gameVO.game_text_1}"/><span class="place-span">값 1</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent1" name="game_percent_1" class="required" value="${gameVO.game_percent_1}"/><span class="place-span">확률 1(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue2" name="game_text_2" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 2</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent2" name="game_percent_2" class="required" value="${gameVO.game_percent_2}"/><span class="place-span">확률 2(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue3" name="game_text_3" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 3</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent3" name="game_percent_3" class="required" value="${gameVO.game_percent_3}"/><span class="place-span">확률 3(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue4" name="game_text_4" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 4</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent4" name="game_percent_4" class="required" value="${gameVO.game_percent_4}"/><span class="place-span">확률 4(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue5" name="game_text_5" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 5</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent5" name="game_percent_5" class="required" value="${gameVO.game_percent_5}"/><span class="place-span">확률 5(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue6" name="game_text_6" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 6</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent6" name="game_percent_6" class="required" value="${gameVO.game_percent_6}"/><span class="place-span">확률 6(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue7" name="game_text_7" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 7</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent7" name="game_percent_7" class="required" value="${gameVO.game_percent_7}"/><span class="place-span">확률 7(%)</span></div>
								</div>
								<div class="d-ib">
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="rouletteValue8" name="game_text_8" class="required" value="${gameVO.game_text_2}"/><span class="place-span">값 8</span></div>
									<div class="inputBox f-l rouletteInput2"><input type="text" required="required" id="roulettePercent8" name="game_percent_8" class="required" value="${gameVO.game_percent_8}"/><span class="place-span">확률 8(%)</span></div>
								</div>
							</div>
						</div>
						<div class="card-body task-description">
							<div class="mt-1 d-flex justify-content-end">
								<button type="button" class="btn btn-primary settingGame" onclick="javascript:fn_settingGameClick();return false;">확인</button>
					...
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">룰렛 상세
								</li>
							</ol>
						</div>
					</div>
