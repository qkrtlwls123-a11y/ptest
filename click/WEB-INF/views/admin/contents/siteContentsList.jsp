...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
    ...
    function fn_siteContentsRegi(){
		document.parameterVO.action = "${pageContext.request.contextPath}/siteContentsRegi.do";
	...
	function fn_changeCompany(idx){
		...
		document.parameterVO.action = "${pageContext.request.contextPath}/siteContentsList.do";
		document.parameterVO.submit();
	}
        ...
        <div class="content-right" style="width: calc(100% - 15px) !important;">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
					...
					<h3 class="content-header-title mb-0 mt-1 pl-1">고객사 콘텐츠</h3>
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">고객사 콘텐츠
								</li>
							</ol>
						</div>
					</div>
                             ...
                             <div class="card-header">
                                 ...
                                 <div class="heading-elements mt-0">
                                     <button class="btn btn-primary btn-md" ><i class="d-md-none d-block feather icon-plus white"></i>
                                         <span class="d-md-block d-none" onclick="javascript:fn_siteContentsRegi();return false;">콘텐츠 등록</span></button>
                                 </div>
                             </div>
                         </div>
								...
								<c:forEach var="resultList" items="${resultList}" varStatus="status">
									...
									<div>
										...
										<div style="width:183px; margin:0 auto;">
											...
											<a href="#" class="btn btn-info" onclick="javascript:fn_contentsDetail('${resultList.contents_id}', '${resultList.company_id}');return false;"><i class="feather icon-upload"></i></a>
