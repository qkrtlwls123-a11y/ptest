                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>인증 완료</span></h6>
                                </div>
                                <div class="card-content">
                                    <div class="card-body" style="text-align:center;">
                                        <p>인증이 완료 되었습니다.</p>
                                        <p class="epb-30">로그인 페이지에서 로그인이 가능합니다.</p>
                                        <p><button type="submit" class="btn btn-primary btn-lg btn-block" onclick="location.href='${pageContext.request.contextPath}/site/${siteVO.site_name}/${companyVO.site_name}'">로그인 페이지 바로가기</button></p>
                                    </div>
                                </div>
                                <div class="card-footer ept-30">
                                    <div class="">
                                    </div>
                                </div>
                            </div>
