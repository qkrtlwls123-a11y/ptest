...
<script type="text/javascript">
	...
	function fn_deleteGroup(idx){
		if(confirm("그룹을 삭제하시겠습니까?")){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/deleteGroup.json",
				type : "POST",
				data : params,
	...
	function fn_updateGroup(){
		...
		var params = $("form[name=parameterVO]").serialize();
		$.ajax({
			url : "${pageContext.request.contextPath}/updateGroupDetail.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
                    ...
                    <div class="row p-1" id="propertyList">
                    	<div class="col-md-2 col-sm-12">
                    		...
                    		<div style="background-color:white;border-radius:0.25rem;">
                    			<div class="list-group" id="groupList" style="height: calc(100vh - 23rem);overflow:auto;">
