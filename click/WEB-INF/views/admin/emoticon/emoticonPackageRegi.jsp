...
<head>
	...
	function fn_insertEmoticon() {
		
		var params = $("form[name=parameterVO]").serialize();
		$.ajax({
			url : "${pageContext.request.contextPath}/insertEmoticon.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    	...
                                    	<input type="hidden" id="emoticon_image" name="emoticon_image" value=""/>
                                        	...
                                        	<div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="패키지 명 " name="emoticon_name" value="" required data-validation-required-message="패키지 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label><span class="required-star">*</span> 패키지 설명</label>
                                                        <input type="text" class="form-control" placeholder="패키지 설명 " name="emoticon_text" value="" required data-validation-required-message="패키지 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
					                        <div class="col-12 col-sm-6">
					                            <div class="card">
				                                    <h5 class="media-heading fw-1000">- 패키지 이미지 <span class="info-text"><i class="feather icon-info"></i> 권장 사이즈 : 140px X 100px</span></h5>
                                        ...
                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            <button type="button" onclick="javascript:fn_insertEmoticon();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">등록</button>
