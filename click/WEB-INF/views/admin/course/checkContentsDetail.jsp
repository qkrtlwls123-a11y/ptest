...
<script type="text/javascript">
	...
	function nextMove() {
		...
		if(nextPage > totalPage){
			...
			location.href="${pageContext.request.contextPath}/checkContentsDetail.do?contents_id="+contentsId+"&contents_detail_id="+nextPage;
		}
	...
	function prevMove() {
		...
		if(nowPage == 1){
			...
			location.href="${pageContext.request.contextPath}/checkContentsDetail.do?contents_id="+contentsId+"&contents_detail_id="+prePage;
	...
	function goPage(idx) {
		...
		$.ajax({
			...
			success : function(result) {
				clearTimeout(timerId);
				location.href="${pageContext.request.contextPath}/checkContentsDetail.do?contents_id="+contentsId+"&contents_detail_id="+idx;
			}
		});
	}
