...
<head>
	...
	function fn_insertSite() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/insertCourse.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
					...
					location.href = "${pageContext.request.contextPath}/courseRegiDetail.do?course_id="+checkCourseId+"&company_id=0";
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="feather icon-airplay mr-25"></i><span class="d-none d-sm-block fw-1000 fs-1">공용 코스 등록</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    	...
                                    	<input type="hidden" id="course_image1" name="course_image1" value=""/>
                                    	<input type="hidden" id="course_image2" name="course_image2" value=""/>
                                        	...
                                        	<div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="코스 명 " name="course_name" value="" required data-validation-required-message="코스 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label><span class="required-star">*</span> 코스 설명</label>
                                                        <input type="text" class="form-control" placeholder="코스 설명 " name="course_text" value="" required data-validation-required-message="코스 설명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control w-25" name="course_people" placeholder="사용자 수">
                                                </div>
                                                <div class="form-group">
                                                    <label>최저 이용 시간</label>
                                                    <input type="text" class="form-control w-25" name="course_time" placeholder="이용시간">
                                                </div>
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox"><input type="checkbox" id="course_main_control" class="custom-control-input">
                                        ...
                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            <button type="button" onclick="javascript:fn_insertSite();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">다음</button>
                                            <button type="reset" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/courseList.do'">취소</button>
                                        </div>
