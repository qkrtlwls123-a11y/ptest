					                            ...
					                            <div class="card">
					                                ...
					                                <div class="card-content collapse show">
					                                    <div class="card-body">
					                                    	...
					                                    	<p id="logoImage"><img class="eImage" style="width:200px;" src="${pageContext.request.contextPath}/file/down/${courseVO.course_image1}"/></p>
					                                    </div>
					                                </div>
					                            </div>
					                        </div>
					                            ...
					                            <div class="card">
					                                ...
					                                <div class="card-content collapse show">
					                                    <div class="card-body">
					                                    	...
					                                    	<p id="backImage"><img class="eImage" style="width:200px;" src="${pageContext.request.contextPath}/file/down/${courseVO.course_image2}"/></p>
					                                    </div>
					                                </div>
					                            </div>
					                        </div>
