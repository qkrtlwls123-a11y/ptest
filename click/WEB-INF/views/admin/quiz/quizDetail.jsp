...
<head>
  ...
  <script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var settingQuizType = '${quizVO.quiz_type}';
		if(settingQuizType == "M"){
		...
		function fn_quizSetting(){
			let wheelNumber = parseInt('${quizVO.quiz_count}');
			
			let htmlString4 = '';
        	for(let i=0;i<wheelNumber;i++){
        		if(i==0){
        			htmlString4 += '<div style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:20px;border:1px solid #00dfc4;"><i class="fa fa-check"></i>&nbsp;문항1</div>';
        		}else if(i==1){
        			htmlString4 += '<div style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="feather fa-check"></i>&nbsp;문항2</div>';
        		}else if(i==2){
        			htmlString4 += '<div style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="feather fa-check"></i>&nbsp;문항3</div>';
        		}else if(i==3){
        			htmlString4 += '<div style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="feather fa-check"></i>&nbsp;문항4</div>';
        		}else if(i==4){
        			htmlString4 += '<div style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="feather fa-check"></i>&nbsp;문항5</div>';
        		}
        	}
		...
		$(document).on("click", ".insertQuiz", function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/updateQuiz.json",
				type : "POST",
				data : params,
			...
			<div class="card shadow-none p-0 m-0">
				...
				<div class="rightArea card-content" id="quizSettingArea">
					<form name="parameterVO" id="parameterVO">
						...
						<input type="hidden" name="quiz_id" value="${quizVO.quiz_id}"/>
						<input type="hidden" name="quiz_answer_1" id="quiz_answer_1" value="${quizVO.quiz_answer_1}"/>
						<input type="hidden" name="quiz_answer_2" id="quiz_answer_2" value="${quizVO.quiz_answer_2}"/>
						<input type="hidden" name="quiz_answer_3" id="quiz_answer_3" value="${quizVO.quiz_answer_3}"/>
						<input type="hidden" name="quiz_answer_4" id="quiz_answer_4" value="${quizVO.quiz_answer_4}"/>
						<input type="hidden" name="quiz_answer_5" id="quiz_answer_5" value="${quizVO.quiz_answer_5}"/>
						...
						<div class="card-body py-0 border-bottom">
							...
							<p><div class="inputBox quizInput2"><input type="text" required="required" id="quiz_name" name="quiz_name" class="required" value="${quizVO.quiz_name}"/><span class="place-span">퀴즈 질문</span></div>
						</div>
						<div class="card-body py-0 border-bottom">
							<div class="assigned d-flex justify-content-between">
								<div class="form-group d-flex align-items-center position-relative font-medium-1 fw-500 ept-20">
							...
							<p><div class="inputBox"><input type="text" required="required" id="quiz_count" name="quiz_count" class="w-50 required numberformat" value="${quizVO.quiz_count}" maxlength="1"/><span class="place-span">개수</span></div>
						</div>
						<div class="card-body py-0 border-bottom">
							<div class="assigned d-flex justify-content-between">
								<div class="form-group d-flex align-items-center position-relative font-medium-1 fw-500 ept-20">
							...
							<div id="quizColorArea" style="display:inline-block;">
								<c:if test='${quizVO.quiz_count > 0}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizText1" name="quiz_text_1" class="required" value="${quizVO.quiz_text_1}"/><span class="place-span">문항 1</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 1}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizText2" name="quiz_text_2" class="required" value="${quizVO.quiz_text_2}"/><span class="place-span">문항 2</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 2}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizText3" name="quiz_text_3" class="required" value="${quizVO.quiz_text_3}"/><span class="place-span">문항 3</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 3}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizText4" name="quiz_text_4" class="required" value="${quizVO.quiz_text_4}"/><span class="place-span">문항 4</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 4}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizText5" name="quiz_text_5" class="required" value="${quizVO.quiz_text_5}"/><span class="place-span">문항 5</span></div>
									</div>
								</c:if>
							</div>
						</div>
						<div class="card-body py-0 border-bottom">
							...
							<div id="quizAnswerArea" style="display:inline-block;">
								<c:if test="${quizVO.quiz_answer_count == '' || quizVO.quiz_answer_count == null}">
								...
								<c:if test="${quizVO.quiz_answer_count != '' || quizVO.quiz_answer_count != null}">
									<p><div class="inputBox"><input type="text" required="required" id="quiz_answer_count" name="quiz_answer_count" class="w-50 required numberformat" value="${quizVO.quiz_answer_count}"  maxlength="1"/><span class="place-span">개수</span></div>
								</c:if>
				...
				<div class="rightArea card-content" id="quizSettingArea2">
					<form name="parameterVO" id="parameterVO2">
						...
						<div class="card-body py-0 border-bottom">
							...
							<p><div class="inputBox quizInput2"><input type="text" required="required" id="quiz_nameS" name="quiz_name" class="required" value="${quizVO.quiz_name}"/><span class="place-span">퀴즈 질문</span></div>
						</div>
						<div class="card-body py-0 border-bottom">
							<div class="assigned d-flex justify-content-between">
								<div class="form-group d-flex align-items-center position-relative font-medium-1 fw-500 ept-20">
							...
							<div id="quizColorArea" style="display:inline-block;">
								<c:if test='${quizVO.quiz_count > 0}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizTextS1" name="quiz_text_1" class="required" value="${quizVO.quiz_text_1}"/><span class="place-span">정답 1</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 1}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizTextS2" name="quiz_text_2" class="required" value="${quizVO.quiz_text_2}"/><span class="place-span">정답 2</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 2}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizTextS3" name="quiz_text_3" class="required" value="${quizVO.quiz_text_3}"/><span class="place-span">정답 3</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 3}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizTextS4" name="quiz_text_4" class="required" value="${quizVO.quiz_text_4}"/><span class="place-span">정답 4</span></div>
									</div>
								</c:if>
								<c:if test='${quizVO.quiz_count > 4}'>
									<div class="d-ib">
										<div class="inputBox f-l quizInput2"><input type="text" required="required" id="quizTextS5" name="quiz_text_5" class="required" value="${quizVO.quiz_text_5}"/><span class="place-span">정답 5</span></div>
									</div>
								</c:if>
							</div>
						</div>
					...
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">퀴즈 수정
								</li>
							</ol>
						</div>
					</div>
