...
<script type="text/javascript">
	...
	function fn_insertMail(){
		var params = $("form[name=parameterVO]").serialize();
		$.ajax({
			url : "${pageContext.request.contextPath}/sendInviteMail.json",
			type : "POST",
			data : params,
            ...
            <div class="content-body">
            	<div class="media mb-1">
                    <div class="media-body">
                        <h5 class="media-heading fw-1000">초대 메일 발송</h5>
                    </div>
                </div>
                <!-- users edit start -->
                		...
                		<div class="col-md-4 col-sm-12">
                			<form name="parameterVO" id="parameterVO">
		                		...
		                		<div class="form-group">
		                            <input type="text" class="form-control w-75 dp-inline required" placeholder="이메일 주소" name="admin_email" id="admin_email">
		                            <button type="button" class="btn btn-primary glow dp-inline" onclick="javascript:fn_insertMail();return false;" style="margin-bottom:3px;">발송</button>
		                        </div>
	                        </form>
                        </div>
                	</div>
