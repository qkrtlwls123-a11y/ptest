			...
			success : function(result) {
				...
				if("M" == result.quizVO.quiz_type){
					...
					var htmlString3 = '<div class="quizArea" style="padding:20px;">'+
										...
										'<div class="quizAnswerArea" style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:20px;border:1px solid #00dfc4;"><i class="'+checkAnswerPoint1+'"></i>&nbsp;'+result.quizVO.quiz_text_1+'</div>'+
										'<div class="quizAnswerArea" style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="'+checkAnswerPoint2+'"></i>&nbsp;'+result.quizVO.quiz_text_2+'</div>'+
										'<div class="quizAnswerArea" style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="'+checkAnswerPoint3+'"></i>&nbsp;'+result.quizVO.quiz_text_3+'</div>'+
										'<div class="quizAnswerArea" style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="'+checkAnswerPoint4+'"></i>&nbsp;'+result.quizVO.quiz_text_4+'</div>'+
										'<div class="quizAnswerArea" style="border-radius:20px;width:90%;color:var(--main-bg-color);background-color:white;margin:0 auto;height:30px;line-height:30px;text-align:left;padding-left:20px;margin-top:10px;border:1px solid #00dfc4;"><i class="'+checkAnswerPoint5+'"></i>&nbsp;'+result.quizVO.quiz_text_5+'</div>'+
							        '</div>';
