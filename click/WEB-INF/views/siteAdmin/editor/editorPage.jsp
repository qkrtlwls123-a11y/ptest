...
<body class="vertical-layout vertical-menu content-left-sidebar todo-application" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar" id="htmlContainer">
	${checkHtml}
