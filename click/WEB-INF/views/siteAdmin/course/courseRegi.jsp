...
<head>
	...
	function fn_insertSite() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/site/${siteVO.site_name}/insertCourse.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
					...
					location.href = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseRegiDetail.do?course_id="+checkCourseId+"&company_id=0";
