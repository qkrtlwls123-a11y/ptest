...
<script type="text/javascript">
	...
	function fn_deleteCourse(){
		var params = $("form[name=parameterVO]").serialize();
    	
    	$.ajax({
			url : "/click/deleteCourse.json",
			type : "POST",
			data : params,
			success : function(result) {
				if(result.resultCode == "success"){
					alert("취소 되었습니다.");
					location.href = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseList.do";
				}else{
					alert("시스템 오류 입니다");
				}
			}
	...
	function fn_updateCourse() {
		...
		location.href = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseContentsDetail.do?course_id="+checkCourseId+"&company_id="+companyId;
	}
            ...
            <div class="content-body">
                ...
                <section id="bg-variants">
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            ...
                                            <button type="reset" class="btn btn-light" onclick="javascript:fn_deleteCourse();return false;'">취소</button>
                                        </div>
                </section>
                <!-- users edit ends -->
            </div>
