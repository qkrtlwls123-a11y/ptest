...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
    ...
    function fn_courseRegi(){
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseRegi.do";
	...
	function fn_courseDetail(idx, companyId){
		...
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseDetail.do";
		document.parameterVO.submit();
	}
	
	function fn_changeCompany(idx){
		$("#company_id").val(idx.value);
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/courseList.do";
		document.parameterVO.submit();
	}
					...
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/site/${siteVO.site_name}/courseList.do">코스 리스트</a>
								</li>
