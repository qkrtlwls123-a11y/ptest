...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
	...
	function fn_emoticonRegi(){
		document.parameterVO.action = "${pageContext.request.contextPath}/emoticonRegi.do";
                             ...
                             <div class="card-header">
                                 ...
                                 <div class="heading-elements mt-0">
                                     <button class="btn btn-primary btn-md" ><i class="d-md-none d-block feather icon-plus white"></i>
                                         <span class="d-md-block d-none" onclick="javascript:fn_emoticonRegi();return false;">이모티콘 등록</span></button>
                                 </div>
                             </div>
                         </div>
                         <div class="emoticonListArea" style="min-height:800px;">
                         	<div class="emoticonList" style="padding:100px 20px;">
								<div class="emoticon">
									<div class="emoticonLines"></div>
									<div class="emoticonBox">
										<img src="http://ptest.co.kr/click/file/down/411" alt="img02">
									</div>
									<div class="emoticonContents">
										<div class="emoticonDetails">
											<h2>title</h2>
											<span class="data">aaaaaaaaaaaaaa</span>
										</div>
									</div>
								</div>
								<div class="emoticon">
