...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
	...
	function fn_noticeRegi(){
		location.href="${pageContext.request.contextPath}/site/${siteVO.site_name}/noticeRegi.do";
	}
	
	function fn_noticeDetail(idx){
		$("#notice_id").val(idx);
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/noticeDetail.do";
        ...
        <div class="content-right" style="width: calc(100% - 15px) !important;">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
					...
					<h3 class="content-header-title mb-0 mt-1 pl-1">공지사항 관리</h3>
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">공지사항 관리
								</li>
							</ol>
						</div>
					</div>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="heading-elements mt-0">
                                            <button class="btn btn-primary btn-md" ><i class="d-md-none d-block feather icon-plus white"></i>
                                                <span class="d-md-block d-none" onclick="javascript:fn_noticeRegi();return false;">공지사항 등록</span></button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table id="" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
                                                ...
                                                <tbody>
                                                	<c:forEach var="noticeList" items="${noticeList}">
	                                                    ...
	                                                    <tr>
	                                                    	<td>
	                                                    		<c:if test="${noticeList.company_id == '0'}">
	                                                    		</c:if>
	                                                    		<c:if test="${noticeList.company_id != '0'}">
	                                                    			<div class="icheckbox_square-blue" style="position: relative;"><input type="checkbox" class="input-chk check" style="position: absolute; opacity: 0;" value="${noticeList.notice_id}"></div>
	                                                    		</c:if>
	                                                    	</td>
	                                                        <td>
	                                                            ${noticeList.company_name}
	                                                        </td>
	                                                        <td class="text-center aa">
	                                                        	<a href="#" onclick="javascript:fn_noticeDetail(${noticeList.notice_id});return false;">${noticeList.notice_title}</a>
	                                                        </td>
	                                                        <td class="double-line bb">${noticeList.notice_writter}</td>
