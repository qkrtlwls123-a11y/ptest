...
<head>
	...
	function fn_insertContents() {
		...
		if($("#contents_main_control").is(":checked")){
			$("#contents_main").val("1");
		}else{
			$("#contents_main").val("0");
		}
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/insertContents.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
					...
					alert("등록되었습니다.");
					location.href = "${pageContext.request.contextPath}/site/${siteVO.site_name}/siteContentsList.do";
				} else {
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="feather icon-airplay mr-25"></i><span class="d-none d-sm-block fw-1000 fs-1">콘텐츠 등록</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    	...
                                    	<input type="hidden" id="contents_image1" name="contents_image1" value=""/>
                                    	<input type="hidden" id="contents_image2" name="contents_image2" value=""/>
                                    	<input type="hidden" id="contents_main" name="contents_main" value="0"/>
                                        <!-- users edit media object start -->
                                        <div class="media mb-1">
                                            <div class="media-body">
                                                <h5 class="media-heading fw-1000">- 콘텐츠 정보</h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-2">
                                        	<div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label><span class="required-star">*</span> 콘텐츠 명</label>
                                                        <input type="text" class="form-control" placeholder="콘텐츠 명 " name="contents_name" value="" required data-validation-required-message="콘텐츠 명은 필수 입력 항목입니다.">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label><span class="required-star">*</span> 접속가능 사용자 수</label>
                                                    <input type="text" class="form-control w-25" name="contents_people" placeholder="사용자 수">
                                                </div>
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox"><input type="checkbox" id="contents_main_control" class="custom-control-input">
                                                        <label class="custom-control-label" for="contents_main_control">메인 등록 여부</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
					                        <div class="col-12 col-sm-6">
					                            <div class="card">
				                                    <h5 class="media-heading fw-1000">- 콘텐츠 표지 <span class="info-text"><i class="feather icon-info"></i> 권장 사이즈 : 400px X 600px</span></h5>
                                        ...
                                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                            <button type="button" onclick="javascript:fn_insertContents();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">등록</button>
                                            <button type="reset" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/siteContentsList.do'">취소</button>
                                        </div>
