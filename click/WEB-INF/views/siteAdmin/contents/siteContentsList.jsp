...
<!--<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/app-assets/images/ico/favicon.ico">-->
    ...
    function fn_siteContentsRegi(){
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/siteContentsRegi.do";
	...
	function fn_contentsDetail(idx, companyId){
		...
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/editor.do";
		document.parameterVO.submit();
	}
	...
	function fn_changeCompany(idx){
		...
		document.parameterVO.action = "${pageContext.request.contextPath}/site/${siteVO.site_name}/siteContentsList.do";
		document.parameterVO.submit();
	}
