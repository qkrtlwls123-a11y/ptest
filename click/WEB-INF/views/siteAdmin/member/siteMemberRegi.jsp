...
<head>
	...
	function fn_insertMember() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/site/${siteVO.site_name}/insertMember.json",
			type : "POST",
			data : params,
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>이메일</label>
                                                    <input type="text" class="form-control" id="member_email" name="member_email" placeholder="이메일" value="">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="member_name" placeholder="성명" value="" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                        	<div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                <button type="button" onclick="javascript:fn_insertMember();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">등록</button>
