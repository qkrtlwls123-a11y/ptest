...
<head>
    ...
    <meta name="description" content="Stack member is super flexible, powerful, clean &amp; modern responsive bootstrap 4 member template with unlimited possibilities.">
    <meta name="keywords" content="member template, stack member template, dashboard template, flat member template, responsive member template, web app">
	...
	function fn_updateMember() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/site/${siteVO.site_name}/updateMember.json",
			type : "POST",
			data : params,
			success : function(result) {
				if (result.resultCode == "success") {
					alert("수정 되었습니다.");
					location.href = "${pageContext.request.contextPath}/site/${siteVO.site_name}/siteMemberList.do";
				} else {
                                ...
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="feather icon-airplay mr-25"></i><span class="d-none d-sm-block fw-1000 fs-1">사용자 등록</span>
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                        ...
                                        <div class="media mb-1">
                                            <div class="media-body">
                                                <h5 class="media-heading fw-1000">- 사용자 정보</h5>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>이메일</label>
                                                    <input type="text" class="form-control" id="member_email" name="member_email" placeholder="이메일" value="${memberVO.member_email}" readonly="readonly">
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="member_name" placeholder="성명" value="${memberVO.member_name}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                        	<div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                <button type="button" onclick="javascript:fn_updateMember();return false;" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">수정</button>
                                                <button type="reset" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/site/${siteVO.site_name}/siteMemberList.do'">취소</button>
                                            </div>
                                        </div>
                                        </form:form>
