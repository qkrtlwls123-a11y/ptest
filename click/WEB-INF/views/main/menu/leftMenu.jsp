...
<div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class=" nav-item"><a href="index.html"><i class="feather icon-package"></i><span class="menu-title" data-i18n="반품관리">반품관리</span></a>
                </li>
				<li class=" nav-item"><a href="${pageContext.request.contextPath}/voomerangSetting.do"><i class="fa fa-chevron-down"></i><span class="menu-title" data-i18n="부메랑관리">부메랑관리</span></a>
                </li>
				<li class=" nav-item"><a href="${pageContext.request.contextPath}/autoReturnSetting.do"><i class="feather icon-settings"></i><span class="menu-title" data-i18n="설정">설정</span></a>
					<ul class="menu-content">
                        <li id="autoReturn"><a class="menu-item" href="${pageContext.request.contextPath}/autoReturn.do" data-i18n="eCommerce">반품 자동 설정</a>
                        </li>
                        <li id="vReturn"><a class="menu-item" href="${pageContext.request.contextPath}/vReturn.do" data-i18n="Analytics">부메랑 설정</a>
						</li>
                    </ul>
                </li>
            </ul>
