...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> 
	...
	<script type="text/javascript">
		...
		var deciblListThreshold1 = 0;
		var deciblListThreshold2 = 0;
		var danger1 = '';
		var danger2 = '';
		var no1 = '';
		var no2 = '';
		...
		function fn_init(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/selectDecibelGraph.json" ,
				type : "POST",
				data: params,
				success : function(result) {
					var tmpArray = new Array();
					deciblListThreshold1 = Number(result.resultList[0].threshold);
					deciblListThreshold2 = Number(result.resultList[1].threshold);
					fn_draw();
				}
			})
		}
...
function fn_draw(){
	Highcharts.chart('container', {
	    ...
	    yAxis: {
	        ...
	        plotBands: [{
	            from: deciblListThreshold1,
	            to: deciblListThreshold1,
	            ...
	            from: deciblListThreshold2,
	            to: deciblListThreshold2,
	            color: 'rgba(192 , 36 , 37 , 0.3)',
	            label: {
	                text: danger2,
	                style: {
