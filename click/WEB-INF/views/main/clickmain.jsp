...
<head>
	...
	<script type="text/javascript">
		...
		function fn_changePage(idx){			
			
			// 화면 이동 시 초기화
			$("#recordCountPerPage").val("10");
			if(idx == 0){
				sessionStorage.setItem("nowUrl", "");
				location.href = "${pageContext.request.contextPath}/siteMain.do"
			}else if(idx == 2){
				$.ajax({
					url : "${pageContext.request.contextPath}/siteList.do",
					type : "POST",
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/siteList.do");
						$(".con-wrap").html(result);
						fn_bindEnterAntion();
					}
				});
				...
				$("#menuId").val(idx);
				$.ajax({
					url : "${pageContext.request.contextPath}/siteRegi.do",
					type : "POST",
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/siteRegi.do");
				...
				$.ajax({
					...
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/adminList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 5){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/adminRegi.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/adminRegi.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 10){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/stampList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/stampList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 11){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/stampDetailList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/stampDetailList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 12){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/stickerList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/stickerList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 13){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/stickerDetailList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/stickerDetailList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 20){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/imageList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/imageList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}else if(idx == 21){
				...
				var params = $("form[name=parameterVO]").serialize();
				$.ajax({
					url : "${pageContext.request.contextPath}/charList.do",
					type : "POST",
					data: params,
					success : function(result) {
						sessionStorage.setItem("nowUrl", "${pageContext.request.contextPath}/charList.do");
						$(".con-wrap").html(result);fn_bindEnterAntion();
					}
				});
			}
