                                            ...
                                            <table id="data-list" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
                                                ...
                                                <tbody>
                                                	<c:forEach var="resultList" items="${resultList}">
	                                                    ...
	                                                    <tr onclick="javascript:fn_updateSite(${resultList.admin_email});return false;">
	                                                        <td>
	                                                        ...
	                                                        <td class="text-center">
	                                                            <c:if test="${resultList.use_yn == 'Y'}">승인</c:if>
	                                                            <c:if test="${resultList.use_yn == 'N'}">미승인</c:if>
	                                                        </td>
