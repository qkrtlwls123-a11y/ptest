...
<body class="vertical-layout vertical-menu content-left-sidebar todo-application  fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar">
            ...
            <div class="content-body">
            	<div class="media mb-1">
                    <div class="media-body">
                        <h5 class="media-heading fw-1000">속성 관리</h5>
                    </div>
                </div>
                <!-- users edit start -->
                <section id="bg-variants">
                    ...
                    <div class="row p-1" id="propertyList">
                    	<c:forEach var="resultList" items="${resultList}" varStatus="status">
                    		<c:if test="${resultList.company_id == 0}">
		                    	<div class="card text-center m-1 property-card">
		                            ...
		                            <div class="card-content">
		                                <div class="card-body">
	                                    	<h5 class="card-text bt-card">${resultList.property_name}<button class="btn btn-primary btn-darken-3 ml-2 pd-05" onclick="javascript:fn_delete('${resultList.property_id}');return false;"><i class="feather icon-x align-middle"></i></button></h5>
		                                </div>
		                            </div>
		                        </div>
	                        </c:if>
	                        <c:if test="${resultList.company_id != 0}">
		                    	<div class="card text-center m-1 property-card property-card2">
									<input type="hidden" id="property_id_${resultList.property_id}" name="property_name_${resultList.property_id}" value="${resultList.property_id}"/>
		                            <div class="card-content">
		                                <div class="card-body">
	                                    	<h5 class="card-text bt-card">${resultList.property_name}<button class="btn btn-info btn-darken-3 ml-2 pd-05" onclick="javascript:fn_delete('${resultList.property_id}');return false;"><i class="feather icon-x align-middle"></i></button></h5>
		                                </div>
		                            </div>
		                        </div>
	                        </c:if>
    ...
    <!-- BEGIN: Page JS-->
    <script src="${pageContext.request.contextPath}/resources/app-assets/js/scripts/pages/siteProperty.js"></script>
    <script src="${pageContext.request.contextPath}/resources/app-assets/js/scripts/navs/navs.js"></script>
    <script src="${pageContext.request.contextPath}/resources/app-assets/js/scripts/pages/property-sub2.js"></script>
