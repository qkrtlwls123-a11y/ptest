					...
					<div class="row breadcrumbs-top mb-1 pl-1">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/stampList.do">스탬프/스티커 관리</a>
								</li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="data-list" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
                                                ...
                                                <tbody>
                                                	<tr onclick="javascript:fn_stampDetail('1');return false;">
														<td class="center">의견 등록하기</td>
														<td class="center">0</td>
													</tr>
													<tr onclick="javascript:fn_stampDetail('2');return false;">
														<td class="center">댓글 등록하기</td>
														<td class="center">0</td>
													</tr>
													<tr onclick="javascript:fn_stampDetail('3');return false;">
														<td class="center">좋아요</td>
														<td class="center">0</td>
													</tr>
													<tr onclick="javascript:fn_stampDetail('4');return false;">
														<td class="center">스크랩</td>
														<td class="center">0</td>
													</tr>
													<tr onclick="javascript:fn_stampDetail('5');return false;">
														<td class="center">학습 시작</td>
														<td class="center">0</td>
													</tr>
													<tr onclick="javascript:fn_stampDetail('6');return false;">
