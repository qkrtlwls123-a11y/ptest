            ...
            <div class="content-body">
            	<div class="media mb-1">
                    <div class="media-body">
                        <h5 class="media-heading fw-1000">그룹 관리</h5>
                    </div>
                </div>
                <!-- users edit start -->
                <section id="bg-variants">
                		...
                		<div class="col-md-4 col-sm-12">
                			<form name="parameterVO" id="parameterVO">
		                		...
		                		<div class="form-group">
		                            <input type="text" class="form-control w-75 dp-inline required" placeholder="그룹명" name="group_name">
                    ...
                    <div class="row p-1" id="propertyList">
                        ...
                        <div class="col-md-3 col-sm-12">
                    		...
                    		<div style="background-color:white;border-radius:0.25rem;">
	                            <div class="list-group" id="groupPropertyList" style="height: calc(100vh - 23rem);overflow:auto;">
	                               
	                           </div>
                           </div>
                        </div>
                        <div class="col-md-6 dp-inline">
                    		<label class="filter-label mb-1 pt-25 w-100 fw-1000">전체 속성 (*더블클릭하여 속성을 추가해보세요.)</label>
                    		<div style="background-color:white;border-radius:0.25rem;height:95%;">
                    			<c:forEach var="sitePropertyList" items="${sitePropertyList}" varStatus="status">
                    				<c:if test="${sitePropertyList.company_id == 0}">
				                    	<div class="card text-center m-1 property-card dp-inline">
			                        ...
			                        <c:if test="${sitePropertyList.company_id != 0}">
				                    	<div class="card text-center m-1 property-card property-card2 dp-inline">
			                            	<input type="hidden" id="property_id_${sitePropertyList.property_id}" name="property_name_${sitePropertyList.property_id}" value="${sitePropertyList.property_id}"/>
				                            <div class="card-content">
				                                <div class="card-body">
				                                    <h5 class="card-text bt-card">${sitePropertyList.property_name}</h5>
