...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<dl id="alertPopupArea" class="pop-main-style02">
				<dt style="background-color:var(--main-bg-color);">퀴즈를 선택하세요.</dt>
				<dd>
					<table id="" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
							...
							<tr>
							<td>
							    ${resultList.quiz_name}
							</td>
							<td class="text-center aa">
								${resultList.quiz_count}개
								
							</td>
							<td class="double-line bb">${resultList.quiz_answer_count}개</td>
							...
							<td>
								<div class="btn btn-secondary list-btn" style="width:60px;" data-tooltip="선택" onclick="javascript:fn_selectQuizDetail('${resultList.quiz_id}');return false;">선택</div>
							</td>
							</tr>
							</c:forEach>
					    </tbody>
